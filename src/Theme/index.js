...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#EB6C22' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#EB6C22',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#EB6C22',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#EB6C22',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #EB6C2230 0%, #fff 0%)`,
})
