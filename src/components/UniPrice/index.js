...
import { USDC_WCORE_PAIR, USDT_WCORE_PAIR } from '../../constants'
...
export default function UniPrice() {
  const usdcPair = usePairData(USDC_WCORE_PAIR)
  const usdtPair = usePairData(USDT_WCORE_PAIR)

  const totalLiquidity = useMemo(() => {
    return usdcPair && usdtPair ? usdcPair.trackedReserveUSD + usdtPair.trackedReserveUSD : 0
  }, [usdcPair, usdtPair])
